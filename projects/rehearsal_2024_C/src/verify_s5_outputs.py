...
def build_registry(summary: dict[str, Any]) -> str:
    ...
    rows = [
        ...
        ("E004", "Q2 二次温度修正 OOF RMSLE 0.360678→0.202567，改善 43.84%", "q2/quadratic_temperature_metrics.json", "python src/verify_s5_outputs.py --config experiments/s2_frozen_config.json", "YES", "材料1、正弦波；同折比较"),
